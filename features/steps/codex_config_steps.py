...
def step_unmarked_operator_codex_config(_context) -> None:  # type: ignore[no-untyped-def]
...
def step_configure_codex_path(_context, configured_path: str) -> None:  # type: ignore[no-untyped-def]
...
def step_customize_managed_codex_config(_context) -> None:  # type: ignore[no-untyped-def]
    target = Path(".codex/config.toml")
...
def step_drift_managed_codex_config(_context) -> None:  # type: ignore[no-untyped-def]
...
def step_remove_managed_codex_config(_context) -> None:  # type: ignore[no-untyped-def]
    Path(".codex/config.toml").unlink()


@then("the Codex config equals the original operator bytes")
def step_operator_codex_config_preserved(context) -> None:  # type: ignore[no-untyped-def]
...
def step_managed_codex_config_complete(_context) -> None:  # type: ignore[no-untyped-def]
...
def step_manifest_codex_config_path(_context, expected: str) -> None:  # type: ignore[no-untyped-def]
