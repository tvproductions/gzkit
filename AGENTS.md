...
- Order versioned identifiers semantically, never lexicographically — **feature ADRs only** (non-`0.0.x` semver). Example: `ADR-0.9.0` comes before `ADR-0.10.0`. Foundation IDs are nominal; see counter-rule below.
