---
name: SQL_Hygiene-Query_Normalization
description: Constrains AI-assisted SQL refactors (SELECT + DML + DDL + PRAGMA) for warehouse sqlite3 code.
applyTo: "src/airlineops/warehouse/**"
---
