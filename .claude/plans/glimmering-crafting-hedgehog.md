...
> Status: plan-audit verdict PASS (project-local copy at
> `.claude/plans/OBPI-0.0.21-07-bdd-chores-distribution.md`). Naming-drift
> defect filed as GHI #313 (plan-audit-gate hook rejects Claude Code
> auto-named plan files).
