...
- Book the patch release as this session's work and leave the
- Fix the CI failure, diagnosed by the operator from the job
- Approve the v0.33.3 release narrative as drafted and
- Decline the near-edge staleness sweep and record it in a
