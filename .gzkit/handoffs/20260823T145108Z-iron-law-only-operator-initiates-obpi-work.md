...
5. ADR-0.35.0 remains the ADR in flight by ascending-semver doctrine — heavy, Pending, 1/10, closeout BLOCKED. It has now been set aside in three consecutive sessions. Any work there is operator-initiated only.
