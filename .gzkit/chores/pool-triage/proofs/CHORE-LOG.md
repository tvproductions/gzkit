...
- Version: 0.1.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (94.85s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmp3f6gyocr\test_broken.py
...
[1] metric=radon_cc value=12.0 band=warn
  ...
  Recommended move: Extract Parameter Object
----------------------------------------------------------------------
Ran 4671 tests in 93.764s

OK (skipped=2)
```
## 2026-06-29T22:03:32-05:00
- Status: PASS
- Chore: pool-triage
- Title: Pool ADR Drift Triage (read-only; stopgap for ADR-pool.pool-management)
- Lane: lite
- Version: 0.1.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (81.07s) -- exit 0 == 0
  - [PASS] `test -d docs/design/adr/pool` => rc=0 (0.01s) -- exit 0 == 0
...
- Version: 0.1.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (85.86s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6808 tests in 85.304s

OK
```
## 2026-07-31T18:41:44-05:00
- Status: PASS
- Chore: pool-triage
- Title: Pool ADR Drift Triage (read-only; stopgap for ADR-pool.pool-management)
- Lane: lite
- Version: 0.1.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (80.15s) -- exit 0 == 0
  - [PASS] `test -d docs/design/adr/pool` => rc=0 (0.01s) -- exit 0 == 0
  - [PASS] `test -d docs/design/adr/pool/archive` => rc=0 (0.00s) -- exit 0 == 0
...
----------------------------------------------------------------------
Ran 7704 tests in 79.548s

OK
```
## 2026-08-01T02:54:53-05:00
- Status: PASS
- Chore: pool-triage
- Title: Pool ADR Drift Triage (read-only; stopgap for ADR-pool.pool-management)
- Lane: lite
- Version: 0.1.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (98.50s) -- exit 0 == 0
  - [PASS] `test -d docs/design/adr/pool` => rc=0 (0.01s) -- exit 0 == 0
  - [PASS] `test -d docs/design/adr/pool/archive` => rc=0 (0.00s) -- exit 0 == 0
