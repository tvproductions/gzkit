...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (94.56s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (1.20s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmpujiobu0o\test_broken.py
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (82.41s) -- exit 0 == 0
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (85.69s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.67s) -- exit 0 == 0
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (78.53s) -- exit 0 == 0
