...
- Criteria Results:
  - [PASS] `uv run gz validate --invariant-coherence` => rc=0 (0.24s) -- exit 0 == 0
  - [PASS] `uv run gz validate --advisory-scorecard` => rc=0 (0.25s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.84s) -- exit 0 == 0
  - [PASS] `uv run gz lint` => rc=0 (0.77s) -- exit 0 == 0
  - [PASS] `uv run mkdocs build --strict` => rc=0 (4.53s) -- exit 0 == 0
  - [PASS] `uv run gz test` => rc=0 (93.06s) -- exit 0 == 0
...
INFO    -  The following pages exist in the docs directory, but are not included in the "nav" configuration:
  ...
  - user/skills/gz-workflow.md
  - user/storybook/from-init-to-first-attested-release.md
INFO    -  Documentation built in 4.40 seconds
[uv run gz test] stdout:
Running unit tests...
Running 651 test suites (10456 total tests) across 10 workers
................................................................................
................................................................................
................................................................................
................................................................................
...
## 2026-09-18 — serial unittest criterion retired class-wide (ruled)

Operator, verbatim: "And, raise to 180", then in flight: "we shouldn't retain serial unittests, why not use parallel everywhere?"

Measured before acting, same tree: serial `uv run -m unittest -q` exit 0 in 238 s — 180 alone would still have timed out; `uv run gz test` (reads `CANONICAL_STEP_COMMANDS["unittest"]`, `unittest-parallel`) exit 0 in 91 s.
Correction to the prior entry: 22 chores carry the full-suite criterion, of which 16 sat under the 120 s ceiling (the other six declare 300 or 900), not 22.
...
- Status: PASS
- Chore: instructions-files-diet
- Title: Instructions, Memory Files & Skill Bodies Diet (Progressive Disclosure)
- Lane: lite
- Version: 3.4.0
- Criteria Results:
  - [PASS] `uv run gz validate --invariant-coherence` => rc=0 (0.24s) -- exit 0 == 0
  - [PASS] `uv run gz validate --advisory-scorecard` => rc=0 (0.24s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.76s) -- exit 0 == 0
  - [PASS] `uv run gz lint` => rc=0 (0.78s) -- exit 0 == 0
  - [PASS] `uv run mkdocs build --strict` => rc=0 (4.43s) -- exit 0 == 0
  - [PASS] `uv run gz test` => rc=0 (96.45s) -- exit 0 == 0
...
INFO    -  The following pages exist in the docs directory, but are not included in the "nav" configuration:
  ...
  - governance/chore-class-system.md
  - governance/codex-interim-parity-2026-09-12.md
  - governance/control-surface-overhaul.md
  - governance/cross-platform-rationale.md
  - governance/defect-fix-routing.md
  - governance/distribution_baseline.md
  - governance/distribution_invariant_catalog.md
  ...
  - user/skills/gz-workflow.md
  - user/storybook/from-init-to-first-attested-release.md
INFO    -  Documentation built in 4.31 seconds
[uv run gz test] stdout:
Running unit tests...
Running 653 test suites (10477 total tests) across 10 workers
................................................................................
................................................................................
................................................................................
................................................................................
