...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (109.44s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmp_8n__gep\test_broken.py
...
[1] metric=radon_cc value=12.0 band=warn
  ...
  Recommended move: Extract Parameter Object
----------------------------------------------------------------------
Ran 4671 tests in 108.197s

OK (skipped=2)
[uvx ruff check src/gzkit --select E722] stdout:
All checks passed!
```
## 2026-06-29T21:56:31-05:00
- Status: PASS
- Chore: exceptions-and-logging-rationalization
- Title: Exceptions & Logging Rationalization
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (82.47s) -- exit 0 == 0
  - [PASS] `uvx ruff check src/gzkit --select E722` => rc=0 (0.06s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6660 tests in 81.955s

OK
[uvx ruff check src/gzkit --select E722] stdout:
All checks passed!
```
## 2026-07-07T05:58:49-05:00
- Status: PASS
- Chore: exceptions-and-logging-rationalization
- Title: Exceptions & Logging Rationalization
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (85.64s) -- exit 0 == 0
  - [PASS] `uvx ruff check src/gzkit --select E722` => rc=0 (0.07s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6808 tests in 85.057s

OK
[uvx ruff check src/gzkit --select E722] stdout:
All checks passed!
```
## 2026-07-31T18:53:19-05:00
- Status: PASS
- Chore: exceptions-and-logging-rationalization
- Title: Exceptions & Logging Rationalization
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (79.39s) -- exit 0 == 0
