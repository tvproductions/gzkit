...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.75s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (1.45s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (94.87s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmphf22t_64\test_broken.py
...
- Criteria Results:
  ...
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.62s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (81.50s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6660 tests in 80.971s

OK
```
## 2026-07-07T06:11:56-05:00
- Status: PASS
- Chore: skill-command-doc-parity
- Title: Skill & Command Documentation Parity
- Lane: heavy
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.80s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (1.19s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (86.06s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6808 tests in 85.475s

OK
```
## 2026-07-31T19:05:16-05:00
- Status: PASS
- Chore: skill-command-doc-parity
- Title: Skill & Command Documentation Parity
- Lane: heavy
...
- Criteria Results:
  ...
  - [PASS] `uv run -m unittest -q` => rc=0 (79.30s) -- exit 0 == 0
