...
### depth 8 — #114, #128, #139, #140, #142, #187, #188, #564
-   #114 (outside the indexed window)
-   #128 (outside the indexed window)
-   #139 (outside the indexed window)
-   #140 (outside the indexed window)
-   #142 (outside the indexed window)
-   #187 (outside the indexed window)
- * #188 plan-audit hook: short-form vs canonical-slug receipt mismatch (class-of-failure fix)
- * #564 preflight: orphan .plan-audit-receipt-OBPI-0.0.64-04-…json left by closeout
