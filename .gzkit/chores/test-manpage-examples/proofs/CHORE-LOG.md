...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (3.02s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (102.72s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmpdnit2bqt\test_broken.py
...
[1] metric=radon_cc value=12.0 band=warn
  ...
  Recommended move: Extract Parameter Object
----------------------------------------------------------------------
Ran 4671 tests in 101.531s

OK (skipped=2)
```
## 2026-06-29T22:17:20-05:00
- Status: PASS
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.50s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (83.16s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6660 tests in 82.632s

OK
```
## 2026-07-07T06:04:43-05:00
- Status: PASS
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
...
- Criteria Results:
  ...
  - [PASS] `uv run -m unittest -q` => rc=0 (86.92s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6808 tests in 86.278s

OK
```
## 2026-07-31T18:58:37-05:00
- Status: PASS
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
...
- Criteria Results:
  ...
  - [PASS] `uv run -m unittest -q` => rc=0 (79.03s) -- exit 0 == 0
