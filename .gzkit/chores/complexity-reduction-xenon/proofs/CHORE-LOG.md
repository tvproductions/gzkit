...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (112.76s) -- exit 0 == 0
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (1.15s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmp8xz5m1m3\test_broken.py
...
[1] metric=radon_cc value=12.0 band=warn
  ...
  Recommended move: Extract Parameter Object
----------------------------------------------------------------------
Ran 4671 tests in 111.514s

OK (skipped=2)
```
## 2026-06-29T21:47:37-05:00
- Status: PASS
- Chore: complexity-reduction-xenon
- Title: Complexity Reduction (Xenon C/C/C)
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (82.21s) -- exit 0 == 0
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (1.63s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6660 tests in 81.669s

OK
```
## 2026-07-07T05:49:10-05:00
- Status: PASS
- Chore: complexity-reduction-xenon
- Title: Complexity Reduction (Xenon C/C/C)
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (88.07s) -- exit 0 == 0
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (0.52s) -- exit 0 == 0
...
/Users/jeff/Documents/Code/gzkit/src/gzkit/pipeline_runtime.py:376: DeprecationWarning: Brief 'OBPI-0.0.37-07-test.md' lacks structured frontmatter fields (allowlist, reqs, verification); loading as LegacyBriefShape. Migrate to structured frontmatter per OBPI-0.0.37-04.
  parsed = parse_brief(brief_path)
----------------------------------------------------------------------
Ran 6808 tests in 87.502s

OK
```
## 2026-07-31T18:43:08-05:00
- Status: PASS
- Chore: complexity-reduction-xenon
- Title: Complexity Reduction (Xenon C/C/C)
- Lane: lite
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (82.12s) -- exit 0 == 0
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (1.09s) -- exit 0 == 0
