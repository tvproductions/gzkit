...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (113.91s) -- exit 0 == 0
  - [PASS] `uv run gz validate --surfaces` => rc=0 (1.22s) -- exit 0 == 0
...
Skipping unparseable file: C:\Users\Jeff\AppData\Local\Temp\tmpf8nt7jfh\test_broken.py
