...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.04s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (1.23s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (52.49s) -- exit 0 == 0
...
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 3243 tests in 51.613s

OK (skipped=1)
```
## 2026-04-19T21:13:42-05:00
- Status: PASS
- Chore: skill-command-doc-parity
- Title: Skill & Command Documentation Parity
- Lane: heavy
...
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.04s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (1.17s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (48.52s) -- exit 0 == 0
