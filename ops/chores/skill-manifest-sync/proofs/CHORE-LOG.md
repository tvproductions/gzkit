...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (33.86s) -- exit 0 == 0
  - [PASS] `uv run gz validate --surfaces` => rc=0 (0.17s) -- exit 0 == 0
...
│               │          │         │       │          │       │ -456d        │
└───────────────┴──────────┴─────────┴───────┴──────────┴───────┴──────────────┘
Claimed: OBPI-0.1.0-01 (agent=unknown-19035, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-19035, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-19035, ttl=240m)
...
No active locks.
{
  ...
  "scan_timestamp": "2026-04-03T00:52:17.150433+00:00"
}
{
  "unlinked_specs": [
    "REQ-0.1.0-01-01"
  ...
  "scan_timestamp": "2026-04-03T00:52:17.150956+00:00"
}
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 2359 tests in 33.616s
