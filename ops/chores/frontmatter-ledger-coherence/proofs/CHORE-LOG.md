...
- Version: 2.0.0
- Criteria Results:
  - [PASS] `uv run gz frontmatter reconcile --dry-run` => rc=0 (0.46s) -- exit 0 == 0

```text
[uv run gz frontmatter reconcile --dry-run] stdout:
Frontmatter-ledger reconciliation DRY-RUN
  ledger cursor:
sha256:11b67b837a96576111ea05579579d971cd21494fb4d43e8fbcade3a89c278b43
  started / ended:   2026-04-21T00:20:32.306380+00:00 /
2026-04-21T00:20:32.625018+00:00
  files rewritten:   1
  pool ADRs skipped: 70
    docs/design/adr/foundation/ADR-0.0.18-adr-taxonomy-doctrine/ADR-0.0.18-adr-t
axonomy-doctrine.md
      status: 'Draft' -> 'Completed'
```
