...
- Criteria Results:
  ...
  - [PASS] `uv run -m unittest -q` => rc=0 (34.91s) -- exit 0 == 0
...
│               │          │         │       │          │       │ -456d        │
└───────────────┴──────────┴─────────┴───────┴──────────┴───────┴──────────────┘
Claimed: OBPI-0.1.0-01 (agent=unknown-24058, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-24058, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-24058, ttl=240m)
...
No active locks.
{
  ...
  "scan_timestamp": "2026-04-03T00:54:06.888353+00:00"
}
{
  "unlinked_specs": [
    "REQ-0.1.0-01-01"
  ...
  "scan_timestamp": "2026-04-03T00:54:06.888957+00:00"
}
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 2359 tests in 34.649s

OK
```
## 2026-04-19T20:04:35-05:00
- Status: FAIL
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
- Version: 1.0.0
- Criteria Results:
  - [FAIL] `uv run gz cli audit` => rc=1 (1.83s) -- exit 1 != 0
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (2.07s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (53.97s) -- exit 0 == 0
...
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 3243 tests in 53.146s

OK (skipped=1)
```
## 2026-04-19T21:18:04-05:00
- Status: PASS
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (1.99s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (51.39s) -- exit 0 == 0
...
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 3243 tests in 50.593s

OK (skipped=1)
```
## 2026-04-24T02:30:10-05:00
- Status: PASS
- Chore: test-manpage-examples
- Title: Test Manpage Examples (Executable Verification)
- Lane: heavy
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (1.31s) -- exit 0 == 0
  - [PASS] `uv run -m unittest -q` => rc=0 (25.57s) -- exit 0 == 0
