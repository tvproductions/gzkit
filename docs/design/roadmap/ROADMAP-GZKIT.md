...
| 8 | 1.2.0 | Evaluation infrastructure | [ADR-pool.evaluation-infrastructure](../adr/pool/ADR-pool.evaluation-infrastructure.md) |
| 9 | 1.3.0 | Controlled agency and recovery | [ADR-pool.controlled-agency-recovery](../adr/pool/ADR-pool.controlled-agency-recovery.md) |

---

## AI Capability Acceptance Intent (Phases 7-9)
