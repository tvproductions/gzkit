---
id: OBPI-0.43.0-03-gz-ghi-triage-skill
...
# OBPI-0.43.0-03-gz-ghi-triage-skill: gz ghi triage skill

## ADR Item

- **Source ADR:** `docs/design/adr/pre-release/ADR-0.43.0-ghi-triage-closeout/ADR-0.43.0-ghi-triage-closeout.md`
- **Checklist Item:** #3 - "OBPI-0.43.0-03: gz ghi triage skill"
...
- [ ] REQ-0.43.0-03-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.43.0-03-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.43.0-03-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
