...
- Create ADR folder structure with briefs/ subdirectory
...
- ADR folder structure must include briefs/ subdirectory
...
- [ ] ADR folder structure created with briefs/ subdirectory
