...
- [x] REQ-0.35.0-16-01: Read both `check-todos-fixmes` hook implementations completely
- [x] REQ-0.35.0-16-02: Document differences: detection patterns, file types, severity, blocking behavior
- [x] REQ-0.35.0-16-03: Evaluate which detection is more comprehensive
- [x] REQ-0.35.0-16-04: Record decision with rationale: Absorb / Confirm
