...
- [x] REQ-0.35.0-03-01: Read both `.pre-commit-config.yaml` entries for `ty-check` completely
- [x] REQ-0.35.0-03-02: Document differences: args, exclude patterns, stages, error handling
- [x] REQ-0.35.0-03-03: Evaluate which configuration is more robust/complete
- [x] REQ-0.35.0-03-04: Record decision with rationale: Absorb / Confirm
