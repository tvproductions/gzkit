...
Absorb (opsdev is better) or Exclude (domain-specific). gzkit has no
equivalent module for documentation generation and validation. The opsdev
module provides dedicated documentation-library capabilities for generating
governance documents from structured data and validating documentation
completeness, making this a strong absorption candidate unless the logic is
ops-specific.
...
- [ ] REQ-0.26.0-12-01: Given the completed comparison, then the brief records
  one final decision: `Absorb` or `Exclude`.
- [ ] REQ-0.26.0-12-02: Given the decision rationale, then it cites concrete
  capability, robustness, or ergonomics differences between opsdev and gzkit.
- [ ] REQ-0.26.0-12-03: Given an `Absorb` outcome, then gzkit contains the
  adapted module/tests needed to carry the pattern safely.
- [ ] REQ-0.26.0-12-04: Given an `Exclude` outcome, then the brief explains why
  the pattern is ops-specific or otherwise not fit for gzkit.
- [ ] REQ-0.26.0-12-05: Given any operator-visible behavior change, then Gate 4
...
rg -n 'Absorb|Exclude' docs/design/adr/pre-release/ADR-0.26.0-governance-library-module-absorption/briefs/OBPI-0.26.0-12-docs-lib.md
# Expected: completed brief records one final decision

rg -n 'src/gzkit/|tests/|Exclude' docs/design/adr/pre-release/ADR-0.26.0-governance-library-module-absorption/briefs/OBPI-0.26.0-12-docs-lib.md
...
rg -n 'Gate 4|N/A|behavioral proof' docs/design/adr/pre-release/ADR-0.26.0-governance-library-module-absorption/briefs/OBPI-0.26.0-12-docs-lib.md
