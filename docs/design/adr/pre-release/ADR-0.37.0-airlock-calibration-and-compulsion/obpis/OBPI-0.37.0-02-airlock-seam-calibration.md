...
- **Checklist Item:** #2 - "OBPI-0.37.0-02 airlock-seam-calibration -- point the default reach adapter at the inverse and thread parent_invariants through all four call sites; live NC asserts a leaf-OBPI entry computes a bounded non-empty seam-map"
...
1. REQUIREMENT: This OBPI MUST deliver: OBPI-0.37.0-02 airlock-seam-calibration -- point the default reach adapter at the inverse and thread parent_invariants through all four call sites; live NC asserts a leaf-OBPI entry computes a bounded non-empty seam-map.
...
- [ ] REQ-0.37.0-02-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.37.0-02-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.37.0-02-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
