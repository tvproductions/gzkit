...
- [ ] OBPI-02's registry-coupled rebuild-fidelity fence is proven live — per parent ADR § Target Scope this deferred-breadth work domain does NOT begin until the keystone monitor refuses a live registry-derived drift (the breadth-gating landing falsifier). This is stricter-than-DAG sequencing, not a code dependency.
