...
- [x] REQ-0.25.0-07-01: [doc] Given the completed comparison, then the brief records
  one final decision: `Absorb` or `Exclude`. — **Exclude** recorded in Decision section.
- [x] REQ-0.25.0-07-02: [doc] Given the decision rationale, then it cites concrete
...
- [x] REQ-0.25.0-07-03: [doc] Given an `Absorb` outcome, then gzkit contains the
  adapted module/tests needed to carry the pattern safely. — N/A (Exclude decision).
- [x] REQ-0.25.0-07-04: [doc] Given an `Exclude` outcome, then the brief explains why
...
- [x] REQ-0.25.0-07-05: [doc] Given any operator-visible behavior change, then Gate 4
