...
- [x] REQ-0.25.0-10-01: Given the completed comparison, then the brief records
  one final decision: `Absorb` or `Exclude`. — **Exclude** recorded in Decision section.
- [x] REQ-0.25.0-10-02: Given the decision rationale, then it cites concrete
...
- [x] REQ-0.25.0-10-03: Given an `Absorb` outcome, then gzkit contains the
  adapted module/tests needed to carry the pattern safely. — N/A (Exclude decision).
- [x] REQ-0.25.0-10-04: Given an `Exclude` outcome, then the brief explains why
...
- [x] REQ-0.25.0-10-05: Given any operator-visible behavior change, then Gate 4
