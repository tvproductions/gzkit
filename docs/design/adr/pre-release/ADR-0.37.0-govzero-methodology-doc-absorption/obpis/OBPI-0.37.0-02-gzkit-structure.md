...
- [x] REQ-0.37.0-02-01: Read both versions completely
- [x] REQ-0.37.0-02-02: Document differences in directory trees, file descriptions, conventions
- [x] REQ-0.37.0-02-03: Evaluate which version is more current and complete
- [x] REQ-0.37.0-02-04: Record decision with rationale: Absorb / Confirm / Merge
