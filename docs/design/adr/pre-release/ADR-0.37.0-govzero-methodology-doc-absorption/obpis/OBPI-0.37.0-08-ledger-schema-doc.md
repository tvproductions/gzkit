...
- [x] REQ-0.37.0-08-01: Read both versions completely
- [x] REQ-0.37.0-08-02: Document differences in schema fields, event types, validation rules
- [x] REQ-0.37.0-08-03: Evaluate which version matches the actual implementation
- [x] REQ-0.37.0-08-04: Record decision with rationale: Absorb / Confirm / Merge
