...
- [x] REQ-0.37.0-18-01: Read both versions completely
- [x] REQ-0.37.0-18-02: Document differences in prerequisites, steps, validation, rollback procedures
- [x] REQ-0.37.0-18-03: Evaluate which version is more complete and actionable
- [x] REQ-0.37.0-18-04: Record decision with rationale: Absorb / Confirm / Merge
