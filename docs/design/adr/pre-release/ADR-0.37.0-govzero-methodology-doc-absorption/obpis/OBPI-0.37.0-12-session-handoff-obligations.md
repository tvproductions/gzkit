...
- [x] REQ-0.37.0-12-01: Read both versions completely
- [x] REQ-0.37.0-12-02: Document differences in obligation lists, required fields, documentation standards
- [x] REQ-0.37.0-12-03: Evaluate which version is more comprehensive
- [x] REQ-0.37.0-12-04: Record decision with rationale: Absorb / Confirm / Merge
