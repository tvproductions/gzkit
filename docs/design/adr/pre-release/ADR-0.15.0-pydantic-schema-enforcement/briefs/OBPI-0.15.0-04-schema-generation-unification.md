...
# OBPI-0.15.0-04-schema-generation-unification: Schema Generation Unification

## ADR Item

- **Source ADR:** `docs/design/adr/pre-release/ADR-0.15.0-pydantic-schema-enforcement/ADR-0.15.0-pydantic-schema-enforcement.md`
- **Checklist Item:** #4 - "OBPI-0.15.0-04: Schema Generation Unification"
...
Unify JSON schema generation from Pydantic models replacing hand-authored schemas.
...
- [ ] REQ-0.15.0-04-01: Given/When/Then behavior criterion 1
- [ ] REQ-0.15.0-04-02: Given/When/Then behavior criterion 2
- [ ] REQ-0.15.0-04-03: Given/When/Then behavior criterion 3
