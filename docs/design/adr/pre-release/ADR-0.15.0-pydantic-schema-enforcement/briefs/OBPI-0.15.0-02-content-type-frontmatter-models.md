...
# OBPI-0.15.0-02-content-type-frontmatter-models: Content Type Frontmatter Models

## ADR Item

- **Source ADR:** `docs/design/adr/pre-release/ADR-0.15.0-pydantic-schema-enforcement/ADR-0.15.0-pydantic-schema-enforcement.md`
- **Checklist Item:** #2 - "OBPI-0.15.0-02: Content Type Frontmatter Models"
...
Create Pydantic frontmatter models for each governance content type.
...
- [ ] REQ-0.15.0-02-01: Given/When/Then behavior criterion 1
- [ ] REQ-0.15.0-02-02: Given/When/Then behavior criterion 2
- [ ] REQ-0.15.0-02-03: Given/When/Then behavior criterion 3
