...
- [x] REQ-0.36.0-11-01: Read the airlineops `sql_hygiene.instructions.md` completely
- [x] REQ-0.36.0-11-02: Categorize each section as: generic (applicable to any SQLite/DB project) or domain-specific (airline data)
- [x] REQ-0.36.0-11-03: If generic patterns exist: document what to extract and propose a new gzkit rules file
- [x] REQ-0.36.0-11-04: Record decision with rationale: Extract / Exclude
