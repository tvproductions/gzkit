...
- [x] REQ-0.32.0-16-01: Read both implementations completely for all three subcommands
- [x] REQ-0.32.0-16-02: Document comparison per subcommand: recon, audit-check, emit-receipt
- [x] REQ-0.32.0-16-03: Record decision with rationale: Absorb Improvements / Confirm Sufficient
- [x] REQ-0.32.0-16-04: If absorbing: adapt to gzkit conventions and write tests
- [x] REQ-0.32.0-16-05: If confirming: document why gzkit's implementations are sufficient
