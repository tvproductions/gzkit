...
- [x] REQ-0.32.0-20-01: Read both implementations completely
- [x] REQ-0.32.0-20-02: Document comparison: sync steps, ordering, idempotency, error handling
- [x] REQ-0.32.0-20-03: Record decision with rationale: Absorb Improvements / Confirm Sufficient
- [x] REQ-0.32.0-20-04: If absorbing: adapt to gzkit conventions and write tests
- [x] REQ-0.32.0-20-05: If confirming: document why gzkit's implementation is sufficient
