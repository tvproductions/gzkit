...
- [x] OBPI-0.13.0-03: Expose structured stage outputs for current stage, blockers, required human action, and next command or resume point
- [x] OBPI-0.13.0-04: Keep Stage 4 human attestation as an explicit authority boundary for Heavy and Foundation work
