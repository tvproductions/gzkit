...
**pilot-instrumentation** — The calibrated pilot measuring false blocks, latency, operator reading time, and decisions changed.
...
1. REQUIREMENT: This OBPI MUST deliver: **pilot-instrumentation** — The calibrated pilot measuring false blocks, latency, operator reading time, and decisions changed.
...
- [ ] REQ-0.36.0-08-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.36.0-08-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.36.0-08-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
