...
**operator-door** — The operator-invoked door: the `second-opinion` slash command, callable on any decision at any moment.
...
- `docs/design/adr/pre-release/ADR-0.36.0-convergence-moment-cross-family-critic/**` — the ADR package this OBPI authors within
...
1. REQUIREMENT: This OBPI MUST deliver: **operator-door** — The operator-invoked door: the `second-opinion` slash command, callable on any decision at any moment.
...
- [ ] Required path exists or is intentionally created in this OBPI: `.gzkit/skills/second-opinion/SKILL.md`
...
- [ ] REQ-0.36.0-03-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.36.0-03-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.36.0-03-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
