...
- [x] REQ-0.34.0-10-01: Read the airlineops implementation completely
- [x] REQ-0.34.0-10-02: Evaluate governance generality (expected: governance-generic)
- [x] REQ-0.34.0-10-03: Adapt to gzkit hook module architecture
- [x] REQ-0.34.0-10-04: Implement and write tests
- [x] REQ-0.34.0-10-05: Document the absorption rationale
