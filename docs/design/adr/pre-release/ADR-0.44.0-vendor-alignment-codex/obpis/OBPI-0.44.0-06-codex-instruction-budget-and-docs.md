...
# OBPI-0.44.0-06-codex-instruction-budget-and-docs: **codex-instruction-budget-and-docs** — Resolve Codex instruction-budget risk, update docs/runbooks, and close GHI #298 with evidence that the Codex surface is now first-class

## ADR Item

- **Source ADR:** `docs/design/adr/pre-release/ADR-0.44.0-vendor-alignment-codex/ADR-0.44.0-vendor-alignment-codex.md`
- **Checklist Item:** #6 - "OBPI-0.44.0-06: **codex-instruction-budget-and-docs** — Resolve Codex instruction-budget risk, update docs/runbooks, and close GHI #298 with evidence that the Codex surface is now first-class"
...
**codex-instruction-budget-and-docs** — Resolve Codex instruction-budget risk, update docs/runbooks, and close GHI #298 with evidence that the Codex surface is now first-class.
...
- `docs/design/adr/pre-release/ADR-0.44.0-vendor-alignment-codex/**` — parent ADR package scope
...
- [ ] REQ-0.44.0-06-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.44.0-06-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.44.0-06-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
