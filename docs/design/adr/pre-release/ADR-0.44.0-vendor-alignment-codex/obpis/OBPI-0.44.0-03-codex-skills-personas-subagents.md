...
# OBPI-0.44.0-03-codex-skills-personas-subagents: **codex-skills-personas-subagents** — Make `.agents/skills`, `agents/openai.yaml`, `.agents/personas`, and Codex subagent role config a coherent generated surface

## ADR Item

- **Source ADR:** `docs/design/adr/pre-release/ADR-0.44.0-vendor-alignment-codex/ADR-0.44.0-vendor-alignment-codex.md`
- **Checklist Item:** #3 - "OBPI-0.44.0-03: **codex-skills-personas-subagents** — Make `.agents/skills`, `agents/openai.yaml`, `.agents/personas`, and Codex subagent role config a coherent generated surface"
...
**codex-skills-personas-subagents** — Make `.agents/skills`, `agents/openai.yaml`, `.agents/personas`, and Codex subagent role config a coherent generated surface.
...
- `.agents/skills` — explicitly referenced by the checklist item
- `agents/openai.yaml` — explicitly referenced by the checklist item
- `.agents/personas` — explicitly referenced by the checklist item
...
test -f .agents/skills
test -f agents/openai.yaml
test -f .agents/personas
```
...
- [ ] REQ-0.44.0-03-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.44.0-03-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.44.0-03-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
