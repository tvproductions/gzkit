...
- `uv run gz adr emit-receipt ADR-0.4.0-skill-capability-mirroring --event validated --attestor "g0" --evidence-json '{"scope":"ADR-0.4.0-skill-capability-mirroring","date":"2026-03-01"}'`
