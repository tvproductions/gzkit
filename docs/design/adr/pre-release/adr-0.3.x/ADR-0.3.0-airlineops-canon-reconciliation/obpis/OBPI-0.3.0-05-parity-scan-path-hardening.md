...
- Files created/modified:
  ...
  - `docs/user/runbook.md`
  - `docs/design/adr/pre-release/adr-0.3.x/ADR-0.3.0-airlineops-canon-reconciliation/obpis/OBPI-0.3.0-05-parity-scan-path-hardening.md`
- Validation commands run:
  ...
  - `uv run gz status`
  - `uv run gz adr emit-receipt ADR-0.3.0 --event validated --attestor "g0" --evidence-json '{"scope":"OBPI-0.3.0-05","adr_completion":"not_completed","obpi_completion":"attested_completed","attestation":"I attest I understand the completion of OBPI-0.3.0-05.","date":"2026-02-15"}'`
- Date completed:
  - 2026-02-15
