...
- [x] REQ-0.28.0-02-01: Read both implementations completely
- [x] REQ-0.28.0-02-02: Document comparison: feature completeness, error handling, cross-platform robustness, test coverage
- [x] REQ-0.28.0-02-03: Record decision with rationale: Absorb / Confirm / Exclude
- [x] REQ-0.28.0-02-04: If Absorb: adapt to gzkit conventions and write tests
- [x] REQ-0.28.0-02-05: If Confirm: document why gzkit's implementation is sufficient
- [x] REQ-0.28.0-02-06: If Exclude: document why the module is domain-specific
