...
4. REQUIREMENT: The validator MUST exit 3 when ANY post-cutoff receipt carries `attestor` matching the regex `^agent:` (case-insensitive). Human attestor strings (`Jeffry Babb`, GitHub noreply addresses) MUST pass.
