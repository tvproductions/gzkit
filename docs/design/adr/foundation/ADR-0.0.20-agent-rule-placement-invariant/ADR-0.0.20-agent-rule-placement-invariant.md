...
- [ ] OBPI-0.0.20-05: Closeout sweep + downstream flags — final grep sweep for residual references; verify mirror regeneration; file downstream GHIs (ADR-0.36.0 WBS refresh #295, ADR-0.38.0 baseline note #296, ADR-0.0.19 reference refresh #297); foundation-kind closeout walkthrough per ADR-0.0.18.
