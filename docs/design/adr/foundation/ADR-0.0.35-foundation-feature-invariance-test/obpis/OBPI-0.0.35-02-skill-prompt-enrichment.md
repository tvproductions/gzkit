...
Before/after excerpt from `.gzkit/skills/gz-plan/SKILL.md` § kind-decision prompt section, showing the enriched test + lens + link inline alongside the existing ADR-0.0.18 heuristic reference.

### Implementation Summary

- Files modified: `.gzkit/skills/gz-design/SKILL.md`, `.gzkit/skills/gz-plan/SKILL.md`, `.gzkit/skills/gz-adr-create/SKILL.md`, `.gzkit/skills/gz-adr-promote/SKILL.md`
- Mirror files regenerated by sync: `.claude/skills/<skill>/SKILL.md` x 4, `.github/skills/<skill>/SKILL.md` x 4
- Skill versions bumped: `gz-design`, `gz-plan`, `gz-adr-create`, `gz-adr-promote` (each minor bump)
- Tests added: none
- Date completed: -
- Attestation status: -
- Defects noted: -
