...
|------|--------|-------------|------|--------|
| 0.0.27 | Validated | g0 | 2026-05-05 | Audit accepted — see `audit/AUDIT.md`; all 7 OBPIs attested-completed, 50/50 REQs covered, validator scopes clean, value demonstrated. |
