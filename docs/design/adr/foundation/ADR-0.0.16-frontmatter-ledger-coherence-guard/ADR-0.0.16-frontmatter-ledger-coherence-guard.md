...
> **Defect note (2026-04-18, GHI #192):** OBPI-04 dogfooding surfaced a pool-skip parity gap between the validator and the chore library. Resolved as a direct `fix(validator)` commit (4e914dd0), not a sixth OBPI — the patch is ~5 lines and follows the precedent of GHI #188/#189 fixes. The withdrawn `OBPI-0.0.16-06-validator-pool-skip-parity` entry remains in the ledger as the audit record.
