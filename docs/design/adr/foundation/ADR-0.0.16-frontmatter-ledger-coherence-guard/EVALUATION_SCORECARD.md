...
|---|-----------|--------|-------------|----------|----------|
| 1 | Problem Clarity | 15% | 1 | 0.15 | No before/current-state language in Intent; No after/target-state language in Intent |
...
|------|-------------|-------------|-------|------|---------|-----|
| validate-frontmatter-guard | 4 | 4 | 4 | 3 | 4 | 3.8 |
| gate-integration | 4 | 4 | 4 | 4 | 4 | 4.0 |
| chore-registration | 2 | 4 | 4 | 4 | 4 | 3.6 |
| backfill-and-ghi-closure | 4 | 4 | 4 | 4 | 4 | 4.0 |
