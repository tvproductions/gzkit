...
- [ ] REQ-0.0.66-06-04 [SUPPORT]: gz next --pool and gz pool graph expose `--json`, are covered in their manpages, and `uv run gz cli audit` exits 0 with both covered; an `artifact_edited` event records the CLI additions.
