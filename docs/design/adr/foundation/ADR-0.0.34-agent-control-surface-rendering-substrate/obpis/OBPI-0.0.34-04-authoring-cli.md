...
- `gz content edit / render / list / show` — explicitly referenced by the checklist item
...
- [ ] Required path exists or is intentionally created in this OBPI: `gz content edit / render / list / show`
...
test -f gz content edit / render / list / show
```
...
- [ ] REQ-0.0.34-04-01: Given the parent ADR intent, when the OBPI implementation is complete, then the primary scoped artifacts exist and match the documented contract
- [ ] REQ-0.0.34-04-02: Given the Allowed Paths in this brief, when the OBPI is executed, then changes remain inside scope and denied paths remain untouched
- [ ] REQ-0.0.34-04-03: Given the Verification commands in this brief, when they run, then evidence is recorded before the OBPI is accepted
