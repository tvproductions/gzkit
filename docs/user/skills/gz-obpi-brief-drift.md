...
The skill reads its canonical execution contract from `.gzkit/skills/gz-obpi-brief-drift/SKILL.md` (mirrored into `.claude/skills/`, `.agents/skills/`, and `.github/skills/`). Follow the agent-facing instructions in that file for the exact execution protocol, stages, and evidence requirements.
...
|------|------|------------|
| `.gzkit/skills/gz-obpi-brief-drift/SKILL.md` | Canonical skill contract | Read |
| `.claude/skills/gz-obpi-brief-drift/SKILL.md` | Claude mirror | Read |
| `.agents/skills/gz-obpi-brief-drift/SKILL.md` | Codex mirror | Read |
| `.github/skills/gz-obpi-brief-drift/SKILL.md` | Copilot mirror | Read |

## Related Skills and Commands

| Related | Relationship |
|---------|-------------|
| [`gz obpi brief-drift`](../manpages/obpi-brief-drift.md) | Underlying CLI command |
| [`/gz-obpi-sync`](gz-obpi-sync.md) | Reconciles OBPI runtime state (distinct from brief-content) |
