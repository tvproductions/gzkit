...
|------|------|------------|
| `.gzkit/skills/gz-init/SKILL.md` | Canonical skill contract | Read |
| `.claude/skills/gz-init/SKILL.md` | Claude mirror | Read |
| `.agents/skills/gz-init/SKILL.md` | Codex mirror | Read |
| `.github/skills/gz-init/SKILL.md` | Copilot mirror | Read |
