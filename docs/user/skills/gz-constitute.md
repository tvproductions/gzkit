...
The skill reads its canonical execution contract from `.gzkit/skills/gz-constitute/SKILL.md` (mirrored into `.claude/skills/`, `.agents/skills/`, and `.github/skills/`). Follow the agent-facing instructions in that file for the exact execution protocol, stages, and evidence requirements.
...
|------|------|------------|
| `.gzkit/skills/gz-constitute/SKILL.md` | Canonical skill contract | Read |
| `.claude/skills/gz-constitute/SKILL.md` | Claude mirror | Read |
| `.agents/skills/gz-constitute/SKILL.md` | Codex mirror | Read |
| `.github/skills/gz-constitute/SKILL.md` | Copilot mirror | Read |
