...
```bash
uv run gz adr emit-receipt ADR-0.3.0 --event validated --attestor "g0" --evidence-json '{"scope":"OBPI-0.3.0-04","adr_completion":"not_completed","obpi_completion":"attested_completed","attestation":"I attest I understand the completion of OBPI-0.3.0-04.","date":"2026-02-14"}'
```
