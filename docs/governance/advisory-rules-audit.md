...
|---|---|
| `agents-md-map-doctrine.md` | `0.4.0` |
| `chores.md` | `0.3.2` |
| `cli.md` | `0.4.0` |
| `gate5-runbook-code-covenant.md` | `0.3.0` |
| `governance-core.md` | `0.12.0` |
