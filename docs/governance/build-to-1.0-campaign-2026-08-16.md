...
**Movement A — Close the Foundation Sunset** *(forward engine; closes a kind — reductive)* — **HELD as of 2026-08-14 (operator-ratified; § Amendments)**; Movement A is HELD *as a Movement*, while its `ADR-0.35.0` box is **TOPMOST in its own right as of 2026-09-01 (operator-ratified; § Amendments)** — no longer merely *the next work* under ADR order (§ Amendments 2026-08-16 — *ADR ORDER IS ABSOLUTE*). Ascending semver and the TOPMOST label now agree rather than pulling apart.
...
### 2026-09-01 (latest) — the CMS / corpora / rendering work is TOPMOST; Movement B steps down (operator-ratified)
