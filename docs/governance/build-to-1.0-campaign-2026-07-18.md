...
- [ ] `ADR-0.44.0-vendor-alignment` is `IN_PROGRESS` and partly landed (`uv run gz adr status ADR-0.44.0-vendor-alignment` for the count) and was tracked by no campaign edition. Finish it or formally park it to pool.
