...
External corroboration tracks the **current** frontier cards in `data/frontier_model_cards.json` (chore `frontier-model-card-currency`; prior-generation citations entered under GHI #308 and were refreshed under GHI #750 and GHI #934 — lineage in git history). External cards corroborate the doctrine; the 2026-04-18 outage taxonomy above remains its authority.
