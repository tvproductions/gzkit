...
- Criteria Results:
  ...
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (0.28s) -- exit 0 == 0
...
│               │          │         │       │          │       │ -456d        │
└───────────────┴──────────┴─────────┴───────┴──────────┴───────┴──────────────┘
Claimed: OBPI-0.1.0-01 (agent=unknown-57890, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-57890, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-57890, ttl=240m)
...
No active locks.
{
  ...
  "scan_timestamp": "2026-04-02T23:32:06.153530+00:00"
}
{
  "unlinked_specs": [
    "REQ-0.1.0-01-01"
  ...
  "scan_timestamp": "2026-04-02T23:32:06.154021+00:00"
}
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 2359 tests in 33.738s
...
- Criteria Results:
  ...
  - [PASS] `uvx xenon --max-absolute C --max-modules C --max-average C src/` => rc=0 (0.32s) -- exit 0 == 0
