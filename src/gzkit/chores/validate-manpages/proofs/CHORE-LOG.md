...
- Version: 1.0.0
- Criteria Results:
  - [FAIL] `uv run gz cli audit` => rc=1 (1.81s) -- exit 1 != 0
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run gz cli audit` => rc=0 (1.35s) -- exit 0 == 0
