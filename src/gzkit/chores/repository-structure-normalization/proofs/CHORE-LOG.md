...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (35.54s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.17s) -- exit 0 == 0
...
│               │          │         │       │          │       │ -456d        │
└───────────────┴──────────┴─────────┴───────┴──────────┴───────┴──────────────┘
Claimed: OBPI-0.1.0-01 (agent=unknown-5018, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-5018, ttl=120m)
Claimed: OBPI-0.1.0-01 (agent=unknown-5018, ttl=240m)
...
No active locks.
{
  ...
  "scan_timestamp": "2026-04-03T00:43:21.382075+00:00"
}
{
  "unlinked_specs": [
    "REQ-0.1.0-01-01"
  ...
  "scan_timestamp": "2026-04-03T00:43:21.382677+00:00"
}
[uv run -m unittest -q] stderr:
----------------------------------------------------------------------
Ran 2359 tests in 35.297s
...
- Version: 1.0.0
- Criteria Results:
  - [PASS] `uv run -m unittest -q` => rc=0 (25.13s) -- exit 0 == 0
  - [PASS] `uv run gz validate --documents --surfaces` => rc=0 (0.31s) -- exit 0 == 0
