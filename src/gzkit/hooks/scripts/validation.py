"""Validation-related Claude hook script generators."""
    ...
    return dedent(
        """\
            ...
            def main():
                ...
                try:
                    ...
                    if looks_like_brief:
                        print(
                            ...
                            "open (AGENTS.md § Gate Covenant: Gate 5 is universal, "
                            "ADR-0.0.36).\\n\\n"
                ...
                requires_human = execution_mode != "exception" and (
                    is_foundation or parent_lane == "Heavy"
                )
