...
_LAZY_HANDLERS: dict[str, str] = {
    ...
    "report_publish_cmd": "gzkit.commands.reports",
    ...
    "obpi_acceptance_cmd": "gzkit.commands.obpi_acceptance",
    "obpi_present_evidence_cmd": "gzkit.commands.obpi_present_evidence",
    "obpi_adversary_workspace_cmd": "gzkit.commands.obpi_adversary_workspace",
