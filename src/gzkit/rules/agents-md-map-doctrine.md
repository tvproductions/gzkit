...
- File size is measured against the budget in `data/instructions_files_budget.json` and reported — **advisory until 1.0, never blocking** (operator ruling 2026-08-17). The same posture binds `gz validate --instructions-files-budget`. The three criteria above stay fail-closed.
