...
_STEP_GUARD_META: dict[str, tuple[str, int]] = {
    ...
    "Rendition lineage": ("rendition-lineage", _mx_levels.ERROR),
    ...
    "Doc code citations": ("doc-code-citations", _mx_levels.ERROR),
...
def _build_check_steps() -> list[tuple[str, CheckStepRunner]]:
    ...
    return [
        ...
        ("Rendition lineage", run_rendition_lineage_audit),
        ...
        ("Doc code citations", run_doc_code_citations_audit),
